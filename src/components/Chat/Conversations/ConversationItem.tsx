...
import { formatAvatars, formatUsernames } from "../../../utils/functions";
...
export const ConversationItem: React.FC<ConversationItemProps> = ({
  ...
  return (
    <Stack
      ...
      {conversation.participants.length === 2 ? (
        <Box
          backgroundImage={formatAvatars(conversation.participants, userId)}
          height={"48px"}
          minWidth={"48px"}
          borderRadius={"50%"}
      ...
      <Flex justify="space-between" width="80%" height="100%">
        ...
        <Text color="whiteAlpha.700" textAlign="right">
          {JSON.stringify(conversation.updatedAt).substring(12, 17)}
        </Text>
      </Flex>
    </Stack>
  );
